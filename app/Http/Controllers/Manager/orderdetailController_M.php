...
class orderdetailController_M extends Controller
{
    /**
  ...
  if(!empty($orderid)){
    ...
    $orderdetail = DB::table('orders');
        ...
        return view('manager.orderdetail.index', compact('orderdetail'));
    }
    ...
    {
        return view('manager.orderdetail.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('manager/orderdetail')->with('flash_message', 'orderdetail added!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.orderdetail.edit', compact('orderdetail'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('manager/orderdetail')->with('flash_message', 'orderdetail updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('manager/orderdetail')->with('flash_message', 'orderdetail deleted!');
    }
}
