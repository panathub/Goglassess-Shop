...
class ProductController_M extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.product.index', compact('product'));
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        return redirect('manager/product')->with('flash_message', 'Product added!');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('manager/product')->with('flash_message', 'Product updated!');
    ...
    public function destroy($id)
    {
        ...
        return redirect('manager/product')->with('flash_message', 'Product deleted!');
    }
